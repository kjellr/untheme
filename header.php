...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'untheme' ); ?></a>
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			?>
				<p class="site-description"><?php echo $untheme_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
