...
if ( ! function_exists( 'untheme_setup' ) ) :
	/**
	...
	function untheme_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'untheme_custom_background_args', array(
...
function untheme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'untheme' ),
		'id'            => 'sidebar-1',
...
function untheme_scripts() {
	...
	wp_enqueue_script( 'untheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'untheme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
